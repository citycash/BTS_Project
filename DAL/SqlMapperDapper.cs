...
#pragma warning restore 612, 618
        ...
        MAKECALLBACK:
            (outputCallbacks ?? (outputCallbacks = new List<Action>())).Add(() =>
            {
                ...
                else
                {
                    ...
                    this.Add(dynamicParamName, expression.Compile().Invoke(target), (DbType?)null, ParameterDirection.InputOutput, sizeToSet);
                }
...
#if !DNXCORE50
    sealed class DataTableHandler : DAL.SqlMapper.ITypeHandler
    {
    ...
    /// Used to pass a DataTable as a TableValuedParameter
    /// </summary>
    sealed partial class TableValuedParameter : DAL.SqlMapper.ICustomQueryParameter
    {
    ...
    /// </summary>
    sealed partial class DbString : DAL.SqlMapper.ICustomQueryParameter
    {
        /// <summary>
